...
import dataBus from "./databus.json";

export default function DatabusAdmin() {
    ...
    return (
        <div className="p-8 bg-gradient-to-r from-indigo-50 to-blue-100 min-h-screen flex flex-col">
            <h1 className="text-3xl font-semibold text-gray-800 mb-6 text-center">Admin Dashboard - Daftar Bus</h1>
